...
LIBGSSAPI_MECH?= ${LIBDESTDIR}${LIBDIR_BASE}/libgssapi_mech.a
LIBGSSAPI_NTLM?= ${LIBDESTDIR}${LIBDIR_BASE}/libgssapi_ntlm.a
LIBGSSAPI_SPNEGO?= ${LIBDESTDIR}${LIBDIR_BASE}/libgssapi_spnego.a
...
LIBHCRYPTO?=	${LIBDESTDIR}${LIBDIR_BASE}/libhcrypto.a
